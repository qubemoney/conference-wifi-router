...
8. run:
```
curl -O https://raw.githubusercontent.com/qubemoney/conference-wifi-router/main/main.sh -o "/usr/bin/qube_main.sh" && chmod +x /usr/bin/qube_main.sh && sh /usr/bin/qube_main.sh
```
